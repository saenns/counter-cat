...
__all__ = ('toggle_device', 'set_scan',
           'enable_le_scan', 'disable_le_scan', 'parse_le_advertising_events','parse_le_advertising_events_init','parse_le_advertising_events_once',
...
def parse_le_advertising_events_init(sock):
    """
...
def parse_le_advertising_events_once(sock, mac_addr=None, packet_length=None, debug=False):
    ...
    return (mac_addr_str, adv_type, rssi)
